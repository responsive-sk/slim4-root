...
interface PathsInterface
{
     ...
     * Get the build path.
     *
     * @param string $buildDirectory Build directory name (default: 'assets')
     * @return string The build path
     */
    public function getBuildPath(string $buildDirectory = 'assets'): string;
     ...
     */
    public function getBuildAssetsPath(string $buildDirectory = 'assets'): string;
     ...
     */
    public function getViteManifestPath(string $buildDirectory = 'assets'): string;
}
